...
> Complete automation system for generating, building, and scheduling LinkedIn content for Harsh Raj Pathak: 16 posts per day (4 Reddit-based + 7 AI news + 5 report-driven performance posts) with carousel PDFs, infographic PNGs, and Slack delivery.

> **Content positioning — the "Varun Mayya of LinkedIn."** As of 2026-06-14, every stream is governed by [`content-doctrine.md`](content-doctrine.md): we write for ambitious generalists who want to know where AI is going and how to get ahead, framed around AI's impact on work, income, skills, and the future. Technical tutorials, indie-hacker tactics, and tool how-tos are out (they underperform); future-of-work, opportunity, and accessible explainers are in. Harsh Raj Pathak stays the brand. The doctrine overrides older topic guidance in any skill file.
...
| `skills/linkedin-performance-engine/SKILL.md` | Performance engine — 5 posts modeled on @harshrajpathak's own analytics |
| `harshrajpathak_linkedin_content_report.md` | Live LinkedIn analytics report — the performance engine reads this each run; drop in an updated report to refresh the winning patterns |
...
| `carousel-routine/brand-kit.html` | Harsh Raj Pathak brand design system HTML |
