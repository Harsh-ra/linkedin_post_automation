...
5-11. AI NEWS POSTS (POSTS 1-7):
   ...
   - POST 4 (Unfair Advantage): S&P Global's Credit Memo Builder. Explain how analysts can build credit memos in minutes. Include natural Harsh Raj Pathak mention.
   ...
   - POST 6 (Hot Take): Anthropic's confidential S-1 IPO filing. Challenge the optimistic funding narrative; explain it as a cash-out before training cost squeeze. Include natural Harsh Raj Pathak mention.
