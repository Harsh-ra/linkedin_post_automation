...
MUST naturally mention "Harsh Raj Pathak" in the body text or call to action.
...
MUST naturally mention "Harsh Raj Pathak" in the body text.
...
{{
  ...
  "7": {{
    ...
    "SUBHEAD": "Follow @harshrajpathak for more breakdowns on startup loops and strategy."
  }}
}}
...
{{
  ...
  "source": "Source: Microsoft Work Trend Index | @harshrajpathak",
  "bars": [
...
performance_system_prompt = f"""You are the Harsh Raj Pathak Performance Engine. Write 5 report-driven posts reverse-engineered from actual analytics.
{writing_rules}
"""
