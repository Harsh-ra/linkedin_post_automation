#!/usr/bin/env python3
"""Generate Harsh Raj Pathak cream-design carousel slides (typography-forward) for both
...
<div class="hright"><div class="fw">Harsh Raj Pathak / 2026</div><div class="badge">{num}</div></div></div>
...
def build(slide, accent, kicker):
    ...
    if slide.get("cta"):
        bottom = '<div class="pill">follow @harshrajpathak for daily <em>frameworks.</em></div>'
    else:
...
write_set("carousel-branded", "#D9785B", "Harsh Raj Pathak / build in public", BRANDED)
write_set("carousel-performance", "#E16259", "Harsh Raj Pathak / founder story", PERF)
print("done")
